 ...
 * Phase D will replace this stub with the real monorepo emit by
 * adapting the shared emitters in _shared.ts to write under apps/web/
 * and swapping the design-system import surface.
 */
import type { ProjectOptions } from '../../types.js';

export async function scaffoldReactNextMonorepo(_options: ProjectOptions): Promise<void> {
  throw new Error('react-next monorepo scaffolder not yet implemented — runs in v0.7.0 Phase D.');
}
