      ...
      <div class="hero-inner">
        ...
        <div class="hero-ctas">
          <!-- v0.9.1 cross-kit audit: hero CTAs are styled <a>
               elements (NOT <hx-button>). The .button-* classes
               match hx-button's visual language via shared design
               tokens, but the underlying element is a real <a> —
               works in Astro's no-JS sweet spot, and before HELiX
               upgrades. Use <hx-button> for interactive controls;
               use styled <a> for navigation. -->
...
<style>
  ...
  /* v0.9.1: button-styled <a> classes for hero CTAs. Mirrors
     ...
     AND in Astro's no-JS sweet spot. */
  .button {
    display: inline-flex;
    align-items: center;
    justify-content: center;
