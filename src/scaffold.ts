    ...
    <HelixProvider>
      <div className="container">
        ...
        <HxCard>
          ...
          <p>
            React Router v7 brings full-stack React with SSR, nested routes, and
            progressive enhancement. HELiX web components integrate natively via
            @lit/react wrappers for type-safe property and event binding.
          </p>
        </HxCard>
      </div>
    </HelixProvider>
...
export default function App() {
  ...
  return (
    <div class="container">
      ...
      <hx-card>
        <div slot="header"><h2>Reactive Counter</h2></div>
      ...
      <hx-card style="margin-top: 1.5rem">
        ...
        <p>SolidJS renders directly to the DOM — no virtual DOM — making it
        ideal for web components. Properties and events bind natively without
        wrappers.</p>
        <div style="display: flex; gap: 0.5rem; margin-top: 1rem;">
          <hx-button variant="primary" size="sm">Primary</hx-button>
          <hx-button variant="secondary" size="sm">Secondary</hx-button>
